...
The hotest comments or newest comments of this weibo could be returned and write down to local files.
'''

import re,time,requests,urllib.request

# weibo_id = input('输入单条微博ID：')
weibo_id = '4154417035431509'
print('weibo_id = 4154417035431509')
